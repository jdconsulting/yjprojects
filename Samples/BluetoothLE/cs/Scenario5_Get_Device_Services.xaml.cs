...
namespace SDKTemplate
{
    ...
    public sealed partial class Scenario5_Get_Device_Services : Page
    {
        ...
        #region UI Code
        public Scenario5_Get_Device_Services()
        {
            InitializeComponent();
        }
        ...
        private async void ServiceList_SelectionChanged()
        {
            ...
            System.Diagnostics.Debug.WriteLine("THESE ARE THE CHARACTERISTICS");
            System.Diagnostics.Debug.WriteLine(characteristics);
            foreach (GattCharacteristic c in characteristics)
            {
                CharacteristicCollection.Add(new BluetoothLEAttributeDisplay(c));
            }
            for (int i = 0; i < CharacteristicCollection.Count; i++){
                System.Diagnostics.Debug.WriteLine(CharacteristicCollection[i].Name);
                //System.Diagnostics.Debug.WriteLine(CharacteristicCollection[i].characteristic.Service);
                //System.Diagnostics.Debug.WriteLine(CharacteristicCollection[i].descriptor.Uuid);
            }  
